...
vars["verundentsorgung_kurztext_st_vw_projekt"] = "ZVWIS"
vars["verundentsorgung_langtext_st_vw_projekt"] = "ZVWIS"
vars["verundentsorgung_id_st_vw_projekt"] = "00000000-0000-0000-0000-000000000004"
        ...
        for i, field in enumerate(layer.fields()):
            ...
            if field.name().startswith("id_st_vw"):
                ...
                if expr == 'a0a79391-649c-40d8-a96d-8377d2a3f790':
                    expr = '43fee930-6483-4965-bd98-27ab0e20ad83'

                #betreiber
                if expr == '05caad03-383c-454c-9f17-f235750a2b48':
                    expr = '7f660ccb-a125-4011-872d-108d0e4d7789'    
